...
- 漫游相机按“拍摄 / 选图 → 人像分析一次 → 调整角色 → 导出 / 分享”组织。设置分为立体配件、人像氛围、卡片文案，点击“应用到卡片”更新预览；随机变身同时组合配件、颜色、模板、心情和称号。
...
- 第二遍绘制：原创猫耳、小熊、兔耳、触角、王冠、土星三角网格，使用关键点构建三维坐标基，配合法线光照和深度测试。支持颜色、大小、上下位置、旋转及多人目标选择。
- 根据配件投影范围自动保留头顶空间，卡片模板保留完整照片并使用模糊填充适配宽高比，避免硬裁掉配件。
