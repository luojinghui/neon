...
export const DEFAULT_PORTRAIT: PortraitSettings = { whitening: 25, smoothing: 20, cartoon: 15, outline: 0, background: 'original', sticker: 'cat', stickerColor: '#ffadcb', stickerScale: 1, stickerY: 0, stickerRotation: 0, faceIndex: 0, mood: '元气满格', caption: '把平凡的一天，过成限定款', signature: '', decoration: 'spark' };
